...
var budgetController = (function () {
    ...
    return {
        ...
        deleteItem: function (type, id) {
            var ids, index;
            //id = 3 - as they are all not in order, if the id is 3 it would delete the index
            //ids = [1,2,4,6,8] delete 6 means deleting index 3
        ...
        calculatePercentages: function () {
            //1. calculate expenses percentages individually
...
var UIController = (function () {
    ...
    var formatNumber = function(num, type) {
        ...
        // + or minus before the number; exactly 2 decimal points; and a decimal point
        num = Math.abs(num);
        num = num.toFixed(2);
        numSplit = num.split('.');
        int = numSplit[0];
